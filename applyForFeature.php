...
<form method="post" name="myForm" onsubmit="return validateForm();">
    <table>
        ...
        <tr><th>Campaign Start Date<br><span>DD/MM/YYYY</span></th><td><input type="text" name="sDate"/></td></tr> 
            <tr><th>Campaign End Date<br><span>DD/MM/YYYY</span></th><td><input type="text" name="eDate"/></td></tr>    
...
$query="INSERT INTO featuredcamps(feature_Name,start_date,expiry_date) VALUES( '$title','$sDate','$eDate')";
